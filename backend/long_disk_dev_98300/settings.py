"""
Django settings for long_disk_dev_98300 project.
...
ROOT_URLCONF = 'long_disk_dev_98300.urls'
...
WSGI_APPLICATION = 'long_disk_dev_98300.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "long_disk_dev_98300 API",
    "DESCRIPTION": "API documentation for long_disk_dev_98300 App",
    "VERSION": "v1",
}
